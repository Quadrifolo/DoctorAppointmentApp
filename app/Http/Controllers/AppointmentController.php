...
class AppointmentController extends Controller
{
    ...
    {
        // Validation To Check if Appointment Date already Exists.
...
// Creates Appointment Instance 
       ...
       // Appointment Time Being Created 
    ...
    public function check(Request $request){
        ...
        // Request Date Input Onto The Form
        $date = $request->date;

        // Search Database For Date where User ID matches the Authorised User's ID Start With the First Date
        $appointment= Appointment::where('date',$date)->where('user_id',auth()->user()->id)->first();
        // If No Appointment Available Then Display The Following Error
        if(!$appointment){
